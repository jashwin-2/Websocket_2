...
public class WebSocketHandler {
    ...
    public WebSocketHandler(AssetManager mAssets, SessionDetails data, WebSocketCallback callback) {
        ...
        try {
            ...
            try {
                ...
                if (get.find()) {
                    ...
                    JsonData data1 = new JsonData(JsonData.INITIAL_DATA, this.sessionDetails, "");
